...
class RSANet(nn.Module):
    def __init__(self,
        ...
        self.up_concat4 = unetUpPadCatConv(filters[3], filters[4], True, norm_type)
        self.up_concat3 = unetUpPadCatConv(filters[2], filters[3], True, norm_type)
        self.up_concat2 = unetUpPadCatConv(filters[1], filters[2], True, norm_type)
        self.up_concat1 = unetUpPadCatConv(filters[0], filters[1], True, norm_type)
