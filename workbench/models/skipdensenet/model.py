...
"""
Taken from: https://github.com/black0017/MedicalZooPytorch/blob/master/lib/medzoo/SkipDenseNet3D.py
...
class SkipDenseNet3D(nn.Module):
    ...
    def __init__(self, in_channels=1, classes=4, growth_rate=16, block_config=(6, 12, 24, 16), num_init_features=32, drop_rate=0.15,
                 bn_size=4):
