...
class WolnyUNet3D(nn.Module):
    """
    Taken from implementation https://github.com/wolny/pytorch-3dunet/blob/master/unet3d/model.py.
    ...
    def __init__(self, in_channels=1, num_classes=1, f_maps=16, layer_order='gcr', num_groups=4):
        super().__init__()
        ...
        self.final_conv = nn.Conv3d(f_maps[0], num_classes, kernel_size=(1,1,1))
...
class ResUNet3D(nn.Module):
    ...
    def __init__(self, in_channels=1, num_classes=1, f_maps=32, conv_layer_order='cge', num_groups=8):
        super().__init__()
